...
class Matriz
{
	...
	const API_URL = 'https://maps.googleapis.com/maps/api/distancematrix/json?units=imperial&origins=%s,BR&destinations=%s,BR&key=AIzaSyAgg5hbeCgmTpUZEm9mkiBSjIhfBuVD5RY';
